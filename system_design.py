...
def terminalcommandlist():
    ...
    comm_list = [
        ...
        ['chmodule', 'Brings up a menu with all avaible modules. ', 'chmodule']
        ]
...
def moduleinfo(module):
    if module == 'CSE':
        ...
        print('An editor module which allows the user to write different scripts of commands which than can be executed through the main module.\n')
    elif module == 'TERMINAL':
        print('\n'+Fore.BLUE + 'Terminal' + Fore.WHITE + ':\n')
        print('Main Terminal Basic module, operates with files and directories inside the machine, executes scripts written in CSE (chmodule->CSE->moduleinfo).\n')
    if module == 'STOM':
